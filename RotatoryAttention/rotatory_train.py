...
import sys
import csv
from rotatory_attention_unet import Rotatory_Attention_Unet
...
def main(load_model=False, starting_epoch=0):
    ...
    num_epochs = 65
    checkpoint_path = "./files/rotatory_attention_unet.pth.tar"
    train_metrics_path = "./files/rotatory_attention_unet_train_metrics.csv"
    test_metrics_path = "./files/rotatory_attention_unet_test_metrics.csv"
...
if __name__ == "__main__":
    main(load_model=True, starting_epoch=20)
