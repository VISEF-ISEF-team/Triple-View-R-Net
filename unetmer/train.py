...
from unetmer_model import Unetmer
...
def main():
    ...
    num_epochs = 50
    checkpoint_path = "./files/2D_unetmer_checkpoint.pth.tar"

    """Initialize model and more"""
    model = Unetmer(inc=1, outc=8, original_size=256)
    model.to(device)
    ...
    df.to_csv("./files/2D_unetmer_metrics_record.csv")
